...
global Blink1_DllPath := ""
Blink1_InitDllPath()

Blink1_InitDllPath()
{
  SplitPath, A_LineFile, , DllDirectory
  Blink1_DllPath := DllDirectory . "\blink1-lib"
}
...
blink1_enumerate()
{
  Result := DllCall(Blink1_DllPath . "\blink1_enumerate", "Cdecl Int")
  return Result
}
...
blink1_open()
{
  Result := DllCall(Blink1_DllPath . "\blink1_open", "Cdecl Ptr")
  return Result
}
...
blink1_close(device)
{
  Result := DllCall(Blink1_DllPath . "\blink1_close", "Ptr", device, "Cdecl")
  return Result
}
...
blink1_getVersion(device)
{
  Result := DllCall(Blink1_DllPath . "\blink1_getVersion", "Ptr", device, "Cdecl Int")
  return Result
}
...
blink1_fadeToRGB(device, fadeMillis, r, g, b)
{
  Result := DllCall(Blink1_DllPath . "\blink1_fadeToRGB", "Ptr", device, "Uint", fadeMillis, "UChar", r, "UChar", g, "UChar", b, "Cdecl Int")
  return Result
}
...
blink1_setRGB(device, r, g, b)
{
  Result := DllCall(Blink1_DllPath . "\blink1_setRGB", "Ptr", device, "UChar", r, "UChar", g, "UChar", b, "Cdecl Int")
  return Result
}
...
blink1_getSerialForDev(device)
{
  Result := DllCall(Blink1_DllPath . "\blink1_getSerialForDev", "Ptr", device, "Cdecl Str")
  return Result
}
...
{
  Result := DllCall(Blink1_DllPath . "\blink1_getCachedCount", "Cdecl Int")
  return Result
}
...
blink1_isMk2(device)
{
  Result := DllCall(Blink1_DllPath . "\blink1_isMk2", "Ptr", device, "Cdecl Int")
  return Result
}
